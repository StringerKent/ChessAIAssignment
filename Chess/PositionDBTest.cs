...
namespace Chess
{
    ...
    public class PositionDBTest
    {
        ...
        public void ScoreBitShift1() {
            ...
            var scorInfo = ScoreInfo.Mate | ScoreInfo.UnsufficienMaterial;
        ...
        public void ScoreBitShiftMax() {
            ...
            var score = 8190;
            var recursions = (byte)31;
            var scoreInfo = ScoreInfo.DrawByRepetion | ScoreInfo.StaleMate | ScoreInfo.Mate | ScoreInfo.UnsufficienMaterial;
            var build = PositionsDatabase.Pack(commandNo, legal, check, score, recursions, scoreInfo);
